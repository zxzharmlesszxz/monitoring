  ...
  <table cellspacing='0' cellpadding='0'>
   ...
   <tbody>
    ...
    <tr>
     ...
     <td>
      ...
      <div class='hint'>
       ...
       используйте -steam для исключения steam серверов
      </div>
     </td>
    </tr>
    
    <tr>
     <td>Поиск по картам:</td>
     <td>
     ...
     <td>
      ...
      <div class='hint'>
       для проверки добавлен ли сервер в мониторинг впишите его IP:PORT<br>
       для игнорирования данного поля, оставьте его пустым, либо впишите *
    ...
    <tr>
     ...
     <td>
      <input type='text' name='freeslots' id='freeslots' value='*'>
      <div class='hint'>
