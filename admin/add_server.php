...
foreach ($countries->countries as $country_code => $country_name) {
 $options .= "<option value='{$country_code}'".(($country_code == $location) ? " selected='selected'" : "").">{$country_name}</option>";
}
    ...
    <div class='content'>
     ...
     <form action='' method='POST'>
      ...
      <div class='row'>
       <label>Опции</label>
       <div class='right'>
        <input type='checkbox' name='server_steam' value='1' id='server_steam' {$checked}>
