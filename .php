...
if($stage == 1) {
	echo "
	<div class='horizontal_line'><br><br><br>Запрос на редактирование сервера<br><br><br></div>
	<div class='cont'>
	";
...
<option value='zombiemod'>Zombie Mod</option>
					...
					<tr>
						...
						<td><input type='text' name='address' value='{$edit->server_data['server_ip']}' size='40'></td>
					</tr>
					<tr>
						<td align='right'>ICQ:</td>
						<td><input type='text' name='icq' value='{$edit->server_data['server_icq']}' size='20'></td>
					</tr>
					<tr>
						<td align='right'>Сайт сервера:</td>
						<td><input type='text' name='site' value='{$edit->server_data['server_site']}' size='40'></td>
					</tr>
					
					
					<tr>
						<td align='right'>Информация о сервере:</td>
						<td><textarea name='about' cols='50'>{$edit->server_data['about']}</textarea></td>
					</tr>
									<tr>
		...
		echo "<div class='msg redbg'>Данный секретный ключ не существует.</div><br><center><a href='index.php'>Вернуться на главную страницу</a></center><br>";
	}
	echo "</div>";
}
