...
if($settings['enable_registration'] == 0){
	...
	if(isset($_POST['submit_registration'])) {
		...
		/*	mysql_connect("192.168.0.1", "monic", "fg_q27I_q3N7lKHm");
			mysql_select_db("mon_servers");
			if($game == "cs16") mysql_query("INSERT INTO p150517_masterserver (`server_ip`,`server_name`,`server_players`,`server_mode`) VALUES ('{$address}','cs16',".time().",0,'free','mon_servers')");
	...
	<textarea style='height:40px;width:585px;' onclick='this.select()' readonly=''><a href='http://contra.net.ua/' target='_blank'&gt;Игровые сервера cs 1.6 Украина</a></textarea></option>
	</tr>
	</center>
		<br>
...
<option value='zombiemod'>Zombie Mod</option>
			...
			<tr>
				<td align='right'><b><font size='2' color='red'>*</font>Адрес нашей ссылки на Вашем сайте:</td>
...
echo "
			...
			<tr>
				...
				<div align='center' style='font-size:12px;color:#CCC;font-weight:bold;padding:10px;'>Посетите сайт игровых серверов <a href='http://contra.net.ua' target='_blank'>contra.net.ua</a></div>
				</td>
			</tr>
		</table>
		</form>";
