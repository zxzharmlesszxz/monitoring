 ...
 <div id="content" class="alone">
  ...
  <div style="padding-left:10px;">
   <ul class="list">
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-8').slideToggle();return(false);">У нас изменилось название сервера. Можно ли изменить название в мониторинге?</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-1').slideToggle();return(false);">Я добавил сервер, почему мне не пришло письмо о том, что он добавлен?</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-2').slideToggle();return(false);">Мне пришло письмо, что сервер добавлен, но я не вижу его на сайте!</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-3').slideToggle();return(false);">Я хочу поднять свой сервер в топ или выделить цветом!</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-4').slideToggle();return(false);">Я перевел на счет деньги с помощью Яndex.money, но они до сих пор не поступили на счет!</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-7').slideToggle();return(false);">Я пополнил свой счет, но не могу сделать заказ, т.к. все места заняты и хочу вернуть средства!</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-6').slideToggle();return(false);">Меня забанили на Вашем сервере!</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-5').slideToggle();return(false);">Мы хотим разместить у Вас рекламу. Сколько и за что?</a>
     </p>
    ...
    <li>
     <p>
      <a href="#" class="js" onclick="$('#f-9').slideToggle();return(false);">Пропали все голоса за сервер, что делать?</a>
     </p>
     <blockquote id="f-9" style="display:none;margin:10px 0;">Настал новый месяц? Все голоса сброшены. Об этом уже давно написано <a href="/how/">здесь</a>.
     </blockquote>
    </li>
    <li>
     <p>
      <a name="feedback-form" href="#" class="js" onclick="$('#f-999').slideToggle();return(false);">Я не нашел здесь ответа на свой вопрос!</a>
     </p>
     <blockquote id="f-999" style="display:none;margin:10px 0;">
      <form action="/feedback/#feedback-form" method="post" class="select_serv_v">
       ...
       <label>Ваш сервер или сайт:</label>
       <input type="text" name="server" size="50" value="" />
       <small>Адрес сервера: IP и порт</small>
