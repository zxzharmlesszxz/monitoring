...
if ($_GET['id'] != '') {
 ...
 <link rel='stylesheet' href='" . THEME . "style_view.css' type='text/css'>
 <link rel='shortcut icon' href='{$settings['site_url']}/favicon.ico'>
 </head>
 <body>";
    ...
    if ($serv['server_status'] == 0) {
        ...
        $img = "<img src='images/maps/no_map.gif' alt='{$locale_view['001']}' width='160' height='120' class='map'>";
