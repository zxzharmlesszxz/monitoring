...
echo "<td valign='top' style='padding-top: 5px;'><div style='padding:10px;background-color: #1E1E1E;border:1px solid #444444'>";
 ...
 HTML-код:<br>
 <textarea rows='3' cols='76'><a href='http://monitoring.contra.net.ua/server/{$server_data['server_id']}'><img src='http://monitoring.contra.net.ua/banner/userbar.png?serv={$server_data['server_ip']}'></a></textarea></p>
 BB-код:<br>
 <textarea rows='3' cols='76'>[url=http://monitoring.contra.net.ua/server/{$server_data['server_id']}][img]http://monitoring.contra.net.ua/banner/userbar.png?serv={$server_data['server_ip']}[/img][/url]</textarea></p>";
     echo "</div>";
...
<div style='font-size: 12px;'>
  <div class='box_rounded'>
   ...
   <center><iframe style='border: 1px solid #7D7D7D;' src='http://monitoring.contra.net.ua/byweb.php?id={$server_data['server_id']}' frameborder='1' width='190' height='250' scrolling='no'></iframe><br><textarea rows='6' cols='24'><iframe src='http://monitoring.contra.net.ua/byweb.php?id={$server_data['server_id']}' frameborder='1' width='190' height='250' scrolling='no'></iframe></textarea></center>
   </div>
...
<b>Юзербары для голосования:</b>
 
<span><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar2(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar2.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar2.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar2.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>
<br>
<br>

<span><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar2(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar4.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar4.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar4.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>
<br>
<br>

<span><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar2(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar3.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar3.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar3.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>


<span><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar5(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar5.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar5.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar5.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>
<br>
<br>

<span style='margin-top:3px;'><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar6(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar6.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar6.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar6.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>
<br><br>
<span><a style='cursor:pointer;color:#04ff00;size:12px;' onclick='userbar1(this)' title='Нажмите для получения кода кнопки'><img src='".$settings['site_url']."userbar1.php?id=".$server_data['server_id']."'></a><div style='display: none;'>
<br>
<font color='#ffffff'><b>HTML-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'><a href='".$settings['site_url']."server/".$server_data['server_id']."' target='_blank'><img src='".$settings['site_url']."userbar1.php?id=".$server_data['server_id']."' border='0'></a></textarea>
<br>
<font color='#ffffff'><b>BB-код:</b></font><br>
<textarea cols='35' rows='3' style='width:300px;height:80px;'>[url=".$settings['site_url']."server/".$server_data['server_id']."][img]".$settings['site_url']."userbar1.php?id=".$server_data['server_id']."[/img][/url]</textarea>
</div></span>
<br><br>

<script type="text/javascript">
 function userbar1(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
 <script type="text/javascript">
 function userbar2(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
 <script type="text/javascript">
 function userbar3(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
 <script type="text/javascript">
 function userbar4(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
 <script type="text/javascript">
 function userbar5(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
 <script type="text/javascript">
 function userbar6(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
 
  <script type="text/javascript">
 function webmodule(xdata){
 obj=xdata.parentNode.childNodes[1].style; tmp=(obj.display!='block') ?
 'block' : 'none'; obj.display=tmp; return false; } 
 </script> 
