...
<div style="padding:10px;background:#232323;line-height:200%;">
		...
		<div style="padding:10px;border-top:1px solid #4F4F4F;">
			<span style="font-size:17px;">Серверам использующим наши услуги <b>запрещено:</b></span><br />
			<div style="padding-top:10px;padding-left:20px;color:#EEE;">
			
— Устанавливать плагины для ридиректа игроков на другие НЕ VIP сервера.<br>
— Изменять игрокам какие либо клиентские файлы игры.<br>
— Не рекомендуется ломать игрокам клиент игры, по возможности используйте бан по IP или подсети.<br>
— Изменять игрокам конфиги игры.<br>
— Вписывать игрокам в меню клиента игры или конфиг рекламу серверов.<br>
— Автоматически, через Motd окна, устанавливать игрокам .exe приложения.<br>
- Накручивать рейтинги в нашем мониторинге, при попытках сервер буден удален и забанен!
</div>
		</div>
...
<div class='listingvip'><font size='4px'>Листинг VIP серверов:</font>
<ol>";
